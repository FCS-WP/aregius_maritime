...
Please install and activate it before starting to use the theme Fabrica.
...
Theme documentation is available on http://fabrica.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Fabrica is Fontello.
