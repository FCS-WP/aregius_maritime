...
if ( ! function_exists( 'fabrica_gutenberg_get_css' ) ) {
	add_filter( 'fabrica_filter_get_css', 'fabrica_gutenberg_get_css', 10, 2 );
	function fabrica_gutenberg_get_css( $css, $args ) {
