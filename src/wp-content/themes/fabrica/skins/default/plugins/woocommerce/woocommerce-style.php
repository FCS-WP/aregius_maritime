...
if ( ! function_exists( 'fabrica_woocommerce_get_css' ) ) {
	add_filter( 'fabrica_filter_get_css', 'fabrica_woocommerce_get_css', 10, 2 );
	function fabrica_woocommerce_get_css( $css, $args ) {
...
$fdir = fabrica_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
