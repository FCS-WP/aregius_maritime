...
( function() {
	...
	var chartOptions = {
	    ...
	    legend: {
	    	itemDistance: fabrica_m_chart_legend_spacer(),
	    	itemMarginBottom: 7,
			itemMarginTop: 0,
	    	itemStyle: {
	            fontSize: '16px',
	...
	function fabrica_m_chart_render(chart) {
		...
		chart.find('.highcharts-legend .highcharts-point').each(function() {
			...
			var rgb = fabrica_m_chart_hexToRgb(fill);
	...
	function fabrica_m_chart_hexToRgb(hex) {
	    var c;
	...
	function fabrica_m_chart_legend_spacer() {
