...
(function() {
	...
	fabrica_add_filter( 'fabrica_filter_select_container_selector', function(selector) {
					...
					btn.on( 'click', function(e) {
						...
						var rez = fabrica_form_validate(form, {
							...
							rules: [
								{
									field: 'EMAIL',
									min_length: {value: 7, message: FABRICA_STORAGE['mc4wp_msg_email_min']},
									max_length: {value: 60, message: FABRICA_STORAGE['mc4wp_msg_email_max']},
									mask: {
	...
	jQuery( document ).on(
		'action.scroll_fabrica', function() {
	...
	jQuery( document ).on(
		'action.resize_fabrica', function() {
			extra_margin_top_video_popup_button();
			fabrica_skin_post_header_init();
			skin_add_custom_width_filter_list();
