...
if ( ! function_exists( 'fabrica_hovers_add_icons' ) ) {
	function fabrica_hovers_add_icons( $hover, $args = array() ) {
		...
		$target    = ! empty( $post_link ) && fabrica_is_external_url( $post_link ) ? ' target="_blank" rel="nofollow"' : '';
		...
		if ( in_array( $hover, array( 'icons', 'zoom' ) ) ) {
			...
			?>
			<div class="icons">
				<a href="<?php echo ! empty( $post_link ) ? esc_url( $post_link ) : $no_link; ?>" <?php fabrica_show_layout($target); ?> aria-hidden="true" class="icon-link
									<?php
