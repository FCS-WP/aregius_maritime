	...
	'action.init_hidden_elements', function(e, cont) {
		...
		if (FABRICA_STORAGE['button_hover'] && FABRICA_STORAGE['button_hover'] != 'default') {
			jQuery(
				...
				// Theme tabs
				+ '.fabrica_tabs .fabrica_tabs_titles li a:not([class*="sc_button_hover_"]),'
				// More link
			...
			).addClass( 'sc_button_hover_just_init sc_button_hover_' + FABRICA_STORAGE['button_hover'] );
			...
			jQuery(
				...
				// Theme tabs
				+ '.fabrica_tabs .fabrica_tabs_titles li a:not([class*="sc_button_hover_style_"]),'
				// Tag cloud
