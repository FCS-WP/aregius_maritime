...
$fabrica_theme_required_plugins        = array(
	...
	'gdpr-framework'         => array(
		'title'       => esc_html__( 'The GDPR Framework', 'fabrica' ),
		'description' => esc_html__( "Tools to help make your website GDPR-compliant. Fully documented, extendable and developer-friendly.", 'fabrica' ),
		'required'    => false,
		'install'     => false,
